...
\definecolor{primary_color}{RGB}{54, 137, 191} 
\definecolor{secondary_color}{RGB}{0, 45, 84} 
...
% 学院
\newcommand{\school}{物理学院 | School of Physics} 
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.2\textwidth]{images/scnu_logo.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/scnu_logo2.png}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        {\large \textbf{华南师范大学}}，专科 \hfill 2021年9月--2025年6月
        \begin{itemize}
            \item 你的学院，你的专业
        ...
        \vspace{0.5em}
        {\large \textbf{华南师范大学}}，本科 \hfill 2025年9月--2028年6月
        \begin{itemize}
            \item 你的学院，你的专业
            \item \textbf{主修课程}：课程1、课程2、课程3、课程4\ 等。
            \item \textbf{GPA}：4.8 / 5.0（排名：1 / 250）
        \end{itemize}
        
        \vspace{0.5em}
        {\large \textbf{华南师范大学}}，硕士 \hfill 2028年9月--至今
        \begin{itemize}
